 ...
 */
final class Version20250225094338 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE note DROP is_favori, CHANGE user_id user_id INT NOT NULL, CHANGE langage_id langage_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE note ADD is_favori TINYINT(1) DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL, CHANGE langage_id langage_id INT DEFAULT NULL');
